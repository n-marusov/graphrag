...
- Rust и Python исключены из кодовой базы, включая прототип (решение владельца продукта 2026-08-30; отменяет прежнее допущение «прототип — Python»).
...
- Онтологический слой: машинно-читаемая модель предметной области (онтология) (инициативы I4/I6).
...
Риски (лицензии/экспорт, 2026-08-30, Q3.1 «Opensource. Добавь риски сам»):
