...
- **F2** — индексация источников знаний (GitLab-спеки и код; книги/легаси из внешнего S3).
...
| Источники | GitLab (webhook + сверка) — спеки/код/онтология; внешнее S3 (события бакета + периодическая сверка) — книги/легаси (глобальный слой, отдельный граф) |
...
flowchart LR
    ...
    I --> INT
    C --> INT
    INT --> GL[GitLab: спеки/код/MR/онтология]
