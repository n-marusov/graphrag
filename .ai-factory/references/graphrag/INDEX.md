# GraphRAG Reference — Index

Навигация по собранным референс-документам для проектирования экспертной системы на базе GraphRAG.

| # | Документ | Тема | Объём |
|---|----------|------|-------|
| 1 | [01-principles.md](01-principles.md) | Принципы GraphRAG: pipeline, ключевые понятия, отличия от Vector RAG | Базовый |
| 2 | [02-taxonomy.md](02-taxonomy.md) | Таксономия методов: Knowledge Organization, Knowledge Retrieval, Knowledge Integration | Обзорный |
| 3 | [03-algorithms.md](03-algorithms.md) | Ключевые алгоритмы: GraphRAG/MS, LightRAG, KAG, HippoRAG, RAPTOR, G-Retriever, GNN-RAG, ToG, StructRAG, PathRAG, GRAG и др. | Детальный |
| 4 | [04-implementations.md](04-implementations.md) | Реализации, open-source проекты, бенчмарки, репозитории | Практический |
...
1. **01-principles.md** — для понимания фундаментальных идей
2. **05-design-guide.md** — для практических рекомендаций по проектированию
3. **02-taxonomy.md** — для систематического обзора методов
4. **03-algorithms.md** — для углублённого изучения конкретных алгоритмов
5. **04-implementations.md** — для выбора готовых компонентов и инструментов