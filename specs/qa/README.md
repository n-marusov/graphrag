...
|---|---|---|
| HTTP API | клиент ↔ query engine (F1) | ответы со ссылками на источники (F1.1), глобальные вопросы (F1.2), multi-hop (F1.2), метрики |
