...
| Онтологический слой (F2) | резолвинг терминов по модели (F2.1), канонические термины (F2.2), обновление модели (F2.3), минимизация контекста (F2.4) | резолвинг термина, unknown term, конфликты терминов |
...
- резолвинг терминов запроса к каноническим терминам модели предметной области (F2.1);
- канонические термины: маппинг синонимов/сокращений в канонический термин (F2.2);
- обновление модели из репозитория (F2.3);
