...
Feature: US-decommission.remove.data Администратор удаляет данные и тома инстанса (вывод из эксплуатации)
  ...
  Scenario: Удаление без риска для исходных данных
    ...
    Then подтверждено: исходные артефакты остались в GitLab/S3; доступы отозваны; риск потери исходных данных отсутствует (решение владельца продукта 2026-08-30)
```
