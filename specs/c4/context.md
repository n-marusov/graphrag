...
- **Акторы** — архетипы пользователей: команда разработки и эксплуатация (внутри организации), ИИ-агенты — внешние пользователи (за границей организации, через MCP). Полный список профилей — `vision.md` §3.1.
...
| ИИ-агенты автоматизации разработки | Внешний пользователь (программный) | Автоматизация разработки: агенты, конвейеры | MCP | Потребители компилятора контекста (F4) |
...
- **ИИ-агенты — внешние пользователи**: за границей организации; доступ — только через MCP (граница F4, vision §2.2).
