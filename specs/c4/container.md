...
C4Container
    ...
    Person(agents, "ИИ-агенты разработки", "Внешние пользователи: ответы и контекст через MCP")
    ...
    Enterprise_Boundary(org, "Организация", "boundary") {
        ...
        System_Boundary(graphrag, "GraphRAG") {
            ...
            ContainerDb(graphstore, "Хранилище графа и векторов", "Neo4j CE", "Граф, векторный индекс, снапшоты")
...
- **Персоны** — архетипы: команда разработки и эксплуатация (внутри организации), ИИ-агенты — внешние пользователи; руководство (менеджер проекта, HR) — в примечаниях `context.md`. Полный список профилей — `vision.md` §3.1.
