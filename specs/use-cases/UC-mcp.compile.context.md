...
**Целевые примечания:** REQ-NFR-security.compliance.llm-contour — безопасный контур LLM (фильтрация утечек, аудит обращений); REQ-NFR-process.compliance.human-confirmation — принцип «агент готовит — человек подтверждает и отвечает»; оба — сквозные требования, не гарантии основного потока.
