...
sequenceDiagram
    ...
    Core->>Store: Чтение опубликованной версии (граф, чанки, векторный индекс)
    Store-->>Core: Чанки, сущности, пути
...
3. Retrieval: чтение опубликованной версии из хранилища графа и векторов, поиск релевантных чанков и путей (PPR/PathRAG — без LLM на этапе извлечения).
