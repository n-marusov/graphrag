...
sequenceDiagram
    ...
    %% --- 1. Локализация ---
    Core->>Store: Чтение графа связей артефактов (опубликованная версия)
    Store-->>Core: Артефакт и его связи
...
2. Ядро локализует артефакт в графе связей артефактов (Artifact Graph) — чтение опубликованной версии из хранилища графа и векторов.
