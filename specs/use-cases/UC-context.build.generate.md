...
sequenceDiagram
    ...
    %% --- 2. Сбор набора ---
    Core->>Store: Чтение набора: связанные артефакты и факты с grounding (по графу связей)
    Store-->>Core: Артефакты с направлениями связей и факты с grounding
...
3. Сбор набора: чтение из хранилища графа и векторов — спеки, код, ADR, факты с grounding.
