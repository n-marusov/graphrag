...
| `US-trace.*` | F3. Оптимизация контекста для автоматической разработки | `impact`, `context`, `check` |
...
- Дополнительные теги для фильтрации: `@answers`, `@knowledge`, `@trace`, `@mcp`; сценарии доступности внутри функциональных историй дополнительно помечаются `@accessibility`
